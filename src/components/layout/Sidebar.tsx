...
export function Sidebar({ projects, activeId, onSelect, onCreate, onWallet, wallet, onGuide }: {
  ...
  return <aside className="sidebar">
    ...
    <div className="workspace-switch"><span className="studio-avatar">YS</span><div><strong>Your studio</strong><span>Independent workspace</span></div><ChevronRight size={15} /></div>
